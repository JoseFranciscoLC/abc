...
$pdf->Cell(40, 10, utf8_decode('Dirección'), 1, 1, 'C', 0);

$pdf->SetFont('Arial', '',11);
while ($row = pg_fetch_array($consulta)) {
	$pdf->Cell(20, 10,$row['numero_empleado'], 1, 0, 'C', 0);
	$pdf->Cell(26, 10, utf8_decode($row['nombre']), 1, 0, 'C', 0);
	$pdf->Cell(38, 10, utf8_decode($row['apellidopaterno']), 1, 0, 'C', 0);
	$pdf->Cell(38, 10, utf8_decode($row['apellidomaterno']), 1, 0, 'C', 0);
	$pdf->Cell(13, 10, $row['edad'], 1, 0, 'C', 0);
	$pdf->Cell(17, 10, utf8_decode($row['genero']), 1, 0, 'C', 0);
