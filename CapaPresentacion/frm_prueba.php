<html>
	...
	<body>
   <div class = "container">
	        <form class="needs-validation" id = "formValidar" novalidate>
  <div class="form-row">
  ...
  <button type="button" id = "botonValidar" class="btn btn-primary">Launch demo modal</button>
</form>
...
<script type = "text/javascript" src = "../NuevosRecursos/js/bootstrap.js"></script>
	...
	<script type = "text/javascript" src = "../NuevosRecursos/js/funciones.js"></script>
		<script type = "text/javascript" src = "js/js_prueba.js"></script>
